...
LAYOUT(
   ...
   * `-------------------------------------------------------------------------'
   */
  XXXXXXX, XXXXXXX,      XXXXXXX, XXXXXXX, UG_TOGG,    UG_NEXT, UG_VALU, UG_HUEU, UG_SATU, XXXXXXX, KC_PSCR, KC_DEL,
  KC_ESC,  XXXXXXX,      XXXXXXX, XXXXXXX, MACRO_RGBI, RGB_M_P, UG_VALD, UG_HUED, UG_SATD, XXXXXXX, XXXXXXX, XXXXXXX,
